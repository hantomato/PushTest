...
import com.nmj.push.pushtest.util.IabBroadcastReceiver;
import com.nmj.push.pushtest.util.IabBroadcastReceiver.IabBroadcastListener;
import com.nmj.push.pushtest.util.IabHelper;
import com.nmj.push.pushtest.util.IabHelper.IabAsyncInProgressException;
import com.nmj.push.pushtest.util.IabResult;
import com.nmj.push.pushtest.util.Inventory;
import com.nmj.push.pushtest.util.Purchase;
...
public class BillingActivity extends Activity implements IabBroadcastListener,
    ...
    static final String SKU_GAS = "com.nmj.push.pushtest.good1";
    ...
    public void onCreate(Bundle savedInstanceState) {
         ...
         */
        String base64EncodedPublicKey = "";

        // Some sanity checks to see if the developer (that's you!) really followed the
        // instructions to run this sample (don't put these checks on your app!)
//        if (base64EncodedPublicKey.contains("")) {
...
//        }
    ...
    IabHelper.OnIabPurchaseFinishedListener mPurchaseFinishedListener = new IabHelper.OnIabPurchaseFinishedListener() {
        public void onIabPurchaseFinished(IabResult result, Purchase purchase) {
            ...
            android.util.Log.d("nmj", "purchase:" + purchase);
